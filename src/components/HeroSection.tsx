...
export default function HeroSection() {
  return (
    <div className="bg-[#060334] relative bg-[linear-gradient(150deg,#060334_50%,#CD63FF_100%)] self-stretch flex w-full flex-col items-stretch pl-20 pr-16 py-11 max-md:max-w-full max-md:px-5">
      <Image
